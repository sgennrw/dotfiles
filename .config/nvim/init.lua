...
require("lazy").setup({
	...
	{ -- Useful plugin to show you pending keybinds.
		...
		opts = {
			...
			spec = {
				...
				{ "<leader>d", group = "[D]ocument/Database" },
	...
	-- Database plugins
	{
		...
		config = function()
			...
			-- Auto-expand query results
			vim.g.db_ui_auto_execute_table_helpers = 1
			vim.g.db_ui_show_database_icon = 1
			vim.g.db_ui_force_echo_messages = 1
			vim.g.db_ui_execute_on_save = 1
			vim.g.db_ui_use_result_buffer = 1
			...
			vim.keymap.set("n", "<leader>du", "<cmd>DBUI<cr>", { desc = "[D]atabase [U]I" })
			vim.keymap.set("n", "<leader>dt", "<cmd>DBUIToggle<cr>", { desc = "[D]atabase [T]oggle" })
